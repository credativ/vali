...
const (
	...
	cfgExternalLabelsKey     = "vali-external-labels"
	cfgURLKey                = "vali-url"
	cfgTLSCAFileKey          = "vali-tls-ca-file"
	cfgTLSCertFileKey        = "vali-tls-cert-file"
	cfgTLSKeyFileKey         = "vali-tls-key-file"
	cfgTLSServerNameKey      = "vali-tls-server-name"
	cfgTLSInsecure           = "vali-tls-insecure-skip-verify"
	cfgProxyURLKey           = "vali-proxy-url"
	cfgTimeoutKey            = "vali-timeout"
	cfgBatchWaitKey          = "vali-batch-wait"
	cfgBatchSizeKey          = "vali-batch-size"
	cfgMinBackoffKey         = "vali-min-backoff"
	cfgMaxBackoffKey         = "vali-max-backoff"
	cfgMaxRetriesKey         = "vali-retries"
	cfgPipelineStagesFileKey = "vali-pipeline-stage-file"
	cfgPipelineStagesKey     = "vali-pipeline-stages"
	cfgTenantIDKey           = "vali-tenant-id"
	cfgNofile                = "no-file"
	cfgKeepFile              = "keep-file"
	cfgRelabelKey            = "vali-relabel-config"
